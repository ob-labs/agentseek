...
当你已经知道要完成什么任务时，使用这些页面。

## 准备

- [配置模型](configure-model.zh.md)
...
- [添加 skill](add-skills.zh.md)
- [安装插件](install-a-plugin.zh.md)
- [使用 ContextSeek](use-contextseek.zh.md)
- [编写 contrib plugin](author-a-contrib-plugin.zh.md)
