...
| `langchain/agentic-rag-hybrid` | LangChain agentic hybrid RAG with image ingestion, vector/sparse/full-text search, comparison demos, and AgentSeek lifecycle spec. |
