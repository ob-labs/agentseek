...
If you plan to run the project in containers, start with the Docker Compose section in Getting started. It covers the default workspace mounts, SQLite tape store path, `.agents/skills`, and `.agents/mcp.json`.
