...
| Context Engineering / Semantic Memory | [reference/contextseek-middleware.md](reference/contextseek-middleware.md) | Agent loses context across sessions, need memory beyond filesystem, semantic / vector retrieval, alternative to `StoreBackend` for cross-session knowledge |
